!(function (e, t) {
  ...
  function Pe(e, t, n) {
    ie(e, n["show".concat(o(t), "Button")], "inline-block"),
      ...
      return n && t.icon === n.icon
        ...
        ? t.icon && -1 === Object.keys(C).indexOf(t.icon)
          ? (s(
            ...
            ne(e))
          : (te(e), Re(e, t), Ne(e, t), void $(e, t.showClass.icon))
        : ne(e);
    },
    Ne = (e, t) => {
    ...
    Qe = (e) => {
      ...
      return (
        a(e.querySelectorAll("swal-param")).forEach((e) => {
          ...
          "boolean" == typeof p[t] && "false" === n && (n = !1),
            "object" == typeof p[t] && (n = JSON.parse(n)),
            (o[t] = n);
        }),
        o
      );
  ...
  const ut = () => {
    ...
    bt = (e, t) => {
      ke && ce(t)
        ? ((e.style.overflowY = "hidden"), t.addEventListener(ke, ft))
    ...
    Ct = (t, n) => {
      ...
      l(n.inputOptions) || d(n.inputOptions)
        ? (wt(j()),
      ...
      n.inputValidator
        ? ((t, n, o) => {
            ...
            const i = Promise.resolve().then(() =>
              u(e.inputValidator(n, e.validationMessage))
            );
            i.then((e) => {
              t.enableButtons();
              t.enableInput();
      ...
      "function" == typeof n.willClose && n.willClose(t),
        s
          ? ((o = e),
            ...
            i.addEventListener(ke, function (e) {
              e.target === i &&
  ...
  class cn {
    ...
    _main(e) {
      ...
      v(Object.assign({}, t, e)),
        de.currentInstance && (de.currentInstance._destroy(), R() && $e()),
  ...
  const ln = (r, s, c) =>
        ...
        Xt.swalPromiseResolve.set(r, e),
          ...
          ((e) => {
            ...
            vt(t, n, e),
              ...
              R() && (yt(t, e.scrollbarPadding, o), Xe()),
              U() ||
    ...
    un = (e, t) => {
      ...
      return (
        (o.showClass = Object.assign({}, p.showClass, o.showClass)),
        (o.hideClass = Object.assign({}, p.hideClass, o.hideClass)),
        o
      );
    },
    dn = (e) => {
    ...
    mn = (e, t) => {
      if (!t.toast)
        return c(t.allowEnterKey) ? void (gn(e, t) || qt(t, -1, 1)) : hn();
    },
    gn = (e, t) =>
